...
import { PAGES } from './pagesIndex.js'
...
export function seekAndBindElement() {
  ...
  // Garbage collection takes care of removing these listeners when the element is destroyed
...
export function initTextNav() {
  seekAndBindElement()
  document.addEventListener('astro:page-load', seekAndBindElement)
}
